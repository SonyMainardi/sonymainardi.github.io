...
export const dictionary = {
  ...
  'hero.cta.resume': { pt: 'Currículo', en: 'Résumé' },
  ...
  'projects.filter': { pt: 'Filtrar projetos por tecnologia', en: 'Filter projects by technology' },
  'projects.updated': { pt: 'Último commit', en: 'Last commit' },
  ...
  'cv.title': { pt: 'Currículo', en: 'Résumé' },
  'cv.print': { pt: 'Imprimir / salvar em PDF', en: 'Print / save as PDF' },
  'cv.back': { pt: 'Voltar ao portfólio', en: 'Back to portfolio' },
  'cv.summary': { pt: 'Resumo', en: 'Summary' },
  'cv.experience': { pt: 'Experiência profissional', en: 'Professional experience' },
  'cv.education': { pt: 'Formação', en: 'Education' },
  'cv.languages': { pt: 'Idiomas', en: 'Languages' },
  'cv.skills': { pt: 'Competências técnicas', en: 'Technical skills' },
  'cv.soft': { pt: 'Competências comportamentais', en: 'Soft skills' },
  'cv.projects': { pt: 'Projetos em destaque', en: 'Selected projects' },

  'a11y.skip': { pt: 'Pular para o conteúdo', en: 'Skip to content' },
  'a11y.nav': { pt: 'Navegação principal', en: 'Main navigation' },
  'a11y.close': { pt: 'Fechar menu', en: 'Close menu' },
  'a11y.avatar': { pt: 'Avatar de Sony Mainardi', en: 'Sony Mainardi avatar' },
